...
const reportSchema = new mongoose.Schema({
  ...
  location: {
    ...
    areaName:  { type: String, default: 'Unknown Area' }, // ✅ ADDED HERE
  },
  ...
  // ── Researcher Assessment Status ──────────────────────────────
  // Set by researcher via ReportsFeedR — shown in admin panel tabs
  researcherStatus: {
    type: String,
    enum: ['verified', 'duplicate', 'under_review', null],
    default: null,
  },
  markedBy:  { type: String, default: null },   // researcher username
