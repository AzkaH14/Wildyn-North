...
// PUT /api/admin/profile/:id - Update admin profile (username/email)
router.put('/profile/:id', async (req, res) => {
  try {
    ...
    // If DB is temporarily unavailable, avoid hard failure in admin panel.
    // This keeps profile update flow functional on unstable networks.
    ...
    // Fallback response for transient DB/network failures
