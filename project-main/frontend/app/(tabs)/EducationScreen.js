        ...
        >
          <View style={styles.container}>
            ...
            <TouchableOpacity
              ...
              activeOpacity={0.9}
              style={styles.alreadyResearcherContainer}
            >
              <Text style={styles.alreadyResearcherText}>Already a Researcher? Login</Text>
            </TouchableOpacity>
          </View>
        </ScrollView>
      </LinearGradient>
...
const styles = StyleSheet.create({
  ...
  alreadyResearcherContainer: {
    width: '100%',
    alignItems: 'center',
    marginTop: 14,
    marginBottom: 8,
  },
  alreadyResearcherText: {
    color: '#FF6B6B',
    fontSize: 13,
    fontWeight: '600',
  },
