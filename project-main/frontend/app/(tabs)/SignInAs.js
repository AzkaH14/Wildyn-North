      ...
      <TouchableOpacity
        ...
        onPress={async () => {
          if (selectedRole === 'researcher') {
            ...
            // If user has already completed researcher signup, don't make them fill education again.
            ...
            // Keep existing behavior of clearing userType selection to avoid UI confusion.
            ...
            // Note: also clear pending researcher draft so community signup starts fresh.
            await AsyncStorage.removeItem('userType');
